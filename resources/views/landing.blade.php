...
<html lang="en">
	...
	<head><base href=""/>
		<title>@isset($title){{ $title }} |@endisset Pangkalan Data</title>
		<meta charset="utf-8" />
		...
		<div class="d-flex flex-column flex-root" id="kt_app_root">
			...
			<div class="mb-0" id="home">
				...
				<div class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom landing-dark-bg" style="background-image: url(assets/media/svg/illustrations/landing.svg)">
					...
					<div class="landing-header pt-3" data-kt-sticky="true" data-kt-sticky-name="landing-header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container">
							...
							<div class="d-flex align-items-center justify-content-between">
								...
								<div class="d-flex align-items-center flex-equal">
									...
									<a href="../../demo41/dist/landing.html">
										{{-- <img alt="Logo" src="assets/media/logos/landing.svg" class="logo-default h-25px h-lg-30px" /> --}}
										<img alt="Logo" src="assets/media/logos/landing-dark.svg" class="logo-sticky h-25px h-lg-30px" />
									</a>
								...
								<div class="flex-equal text-end ms-1">
									<a href="../../demo41/dist/authentication/layouts/corporate/sign-in.html" class="btn btn-success">Sign In</a>
								</div>
					...
					<div class="d-flex flex-column flex-center w-100 min-h-350px min-h-lg-500px px-9">
						...
						<div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
							...
							<a href="../../demo41/dist/index.html" class="btn btn-primary">Try Metronic</a>
				...
				<div class="pb-15 pt-18 landing-dark-bg">
					...
					<div class="container">
						...
						<div class="fs-2 fw-semibold text-muted text-center">
							<a href="../../demo41/dist/account/security.html" class="link-primary fs-4 fw-bold">Marcus Levy,</a>
						...
						<div class="row py-10 py-lg-20">
							...
							<div class="col-lg-6 pe-lg-16 mb-10 mb-lg-0">
								...
								<div class="rounded landing-dark-border p-9">
									...
									<a href="../../demo41/dist/pages/user-profile/overview.html" class="text-white opacity-50 text-hover-primary">Click to Get a Quote</a></span>
